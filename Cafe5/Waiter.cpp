...
const std::string Waiter::getName(){

	return name_;
}


void Waiter::setSurname(std::string surname){
	surname_ = surname;
}


std::string Waiter::getSurname(){

	return surname_;
}


void Waiter::setSpecialization(Specialization sp){
	specialization_ = sp;
}


Specialization Waiter::getSpecialization(){
	return  specialization_;
}

std::string Waiter::getFullName(){
